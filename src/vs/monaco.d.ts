...
declare namespace monaco.editor {
	...
	export class StandaloneTheme implements IStandaloneTheme {
		...
		constructor(name: string, standaloneThemeData: IStandaloneThemeData, semanticHighlighting?: boolean);
		get label(): string;
		get base(): string;
...
declare namespace monaco.extra {
	 ...
	 * to their own tuple.
	 */
	type GetLeadingNonServiceArgs<Args> = Args extends [...BrandedService[]] ? [] : Args extends [infer A, ...BrandedService[]] ? [A] : Args extends [infer A, ...infer R] ? [A, ...GetLeadingNonServiceArgs<R>] : never;
	 ...
	 */
		...
		export const ITextModelService: ServiceIdentifier<ITextModelService>;
