...
import { StandaloneTheme, StandaloneThemeService } from 'vs/editor/standalone/browser/standaloneThemeService';
...
export function createMonacoEditorAPI(): typeof monaco.editor {
	return {
		...
		StandaloneThemeService: <any>StandaloneThemeService,
		StandaloneTheme: <any>StandaloneTheme,
